    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnFeed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mPref.getInt("canBeFed", 0) > 0 && mPref.getInt("fed", 6) < 6) {
                    // TODO 급식 모듈이 getAction으로 안가져갔을 때(controlCode가 NULL이 아닐 때) 수행하지 않아야 함
        ...
        btnAutoFeedSetting.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                boolean isAutoNow = mPref.getBoolean("isAutoNow", false);
                ...
                builder.setPositiveButton("설정", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (switchAutoFeed.isChecked()) {
                            ...
                            Toast.makeText(FeedingActivity.this, "알람 설정됌", Toast.LENGTH_SHORT).show();
                        } else {
                            am.cancel(sender);

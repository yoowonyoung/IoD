...
public class TemperatureManageActivity extends AppCompatActivity {
    ...
    private void getHomeStatus() throws IOException {
        ...
        String url = "http://201310491.iptime.org:6974/iodsc/iodcontrol?action=getHomeStatus";
    ...
    private void setControl(String controlCode) throws IOException {
        httpClient = new DefaultHttpClient();
        httpClient.getParams().setParameter("http.connection.timeout", 5000);
        String url = "http://201310491.iptime.org:6974/iodsc/iodcontrol?action=setControl&moduleName=ENVN&controlCode=";
        url += controlCode;
        httpGet = new HttpGet(url);
        ResponseHandler<String> responseHandler = new BasicResponseHandler();
